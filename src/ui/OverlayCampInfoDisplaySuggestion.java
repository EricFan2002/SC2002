...
public class OverlayCampInfoDisplaySuggestion extends OverlayCampInfoDisplay {
    ...
    public OverlayCampInfoDisplaySuggestion(int x, int y, int offsetY, int offsetX, String windowName, Camp camp, Student student, Window mainWindow, Suggestion suggestion) {
    ...
    public void messageLoop() {
        ...
        if(submitButton.getPressed()){
            ...
            if(editSuggestion != null){
                ...
                RepositoryCollection.suggestionRepository.insert(editSuggestion);
            }
