    ...
    public void messageLoop() {
        ...
        if(allSuggestions.getSelectedOption() != -1){
            ...
            if(selectedSuggestion != null) {
                ...
                OverlayChooseBox overlayChooseBox = new OverlayChooseBox(30, buttonPosition.getY(), getX() + buttonPosition.getX() + (getLenX() / 2 - 15), "Actions", options, OverlayCampSuggestionStaffView.this);
